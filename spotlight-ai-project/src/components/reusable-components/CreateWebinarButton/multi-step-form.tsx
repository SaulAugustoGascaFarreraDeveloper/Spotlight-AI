    ...
    const onHandleNext = async() => {
        ...
        if(isLastStep)
        {
            try{
                ...
                {
                    toast.success('Your webinar has been created succesfully')

                    onComplete(result.webinarId)
                }else{

                    toast.error(
                        result?.message || 'Your webinar has not been created'
                    )
  ...
  return (
    ...
    overflow-hidden max-w-6xl mx-auto backdrop-blur-[106px]'>
                                    ...
                                    <div className="relative">
                                        ...
                                        </motion.div>
                                        {
                                            index < steps.length - 1 && (
                                                ...
                                                w-0.5 h-16 bg-gray-700 overflow-hidden">
                                                    <motion.div
                                                        initial={{
                                    ...
                                    <div className='pt-1'>
                                        <motion.h3
                                            animate={{
                                                ...
                                                'rgb(255,255,255)' : 'rgb(156, 163, 175)'
                                            }}
                                            transition={{duration: 0.3}}
                    ...
                    >
                        <div className="mb-6">
                         ...
                         {currentStep.component}
                          ...
                          {validationError && (
                            <div className='mt-4 p-3 bg-red-900/30 border border-e-red-800 rounded-md flex items-start gap-2 text-red-300'>
        ...
        <div className="w-full p-6 flex justify-between">
            ...
            <Button disabled={isSubmitting} onClick={onHandleNext} className='hover:cursor-pointer'>
